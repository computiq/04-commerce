...
from commerce.controllers import products_controller, address_controller, vendor_controller, order_controller , add_controller
...
api.add_router('add', add_controller)
